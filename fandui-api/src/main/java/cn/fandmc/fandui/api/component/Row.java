...
/** Horizontal linear layout with configurable gap, alignment, and flex children. */
public final class Row extends UiContainer {
    private float gap;
    ...
    public static Row of(UiComponent... children) {
